...
public class AssociationsTest {
    ...
    public void testFindIconForFiles() throws Exception {
        ...
        assertAssociationMatches("Java", "JettyRunner.java");
    ...
    private void assertAssociationMatches(String associationName, String fileName, String fileType) {
        final Association associationForFile = associations.findAssociationForFile(new TestFileInfo(fileName, fileType));
    ...
    private class TestFileInfo implements FileInfo {
        ...
        public TestFileInfo(String fileName, String fileType) {
